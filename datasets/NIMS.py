...
from ._utils import StandardScaler, tabular_train_test_split

logger = logging.getLogger(__name__)


@register("mydata")
class NIMSDataModule(DataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        if not self.did_setup:
            df = pd.read_csv("D:/Postgraduate/106/Uncertainty/code/natural-posterior-network-main/natpn/datasets/NIMS.csv")
